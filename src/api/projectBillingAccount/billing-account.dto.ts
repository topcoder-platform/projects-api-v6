...
export class BillingAccountResponseDto {
  @ApiProperty({ name: 'tcBillingAccountId', description: 'TopCoder billing account id'})
...
export class ListBillingAccountItem {
  @ApiProperty({ name: 'sfBillingAccountId', description: 'Salesforce billing account id'})
