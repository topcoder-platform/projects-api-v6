...
export const GeneralPermission = (
  ...
  const permissionsRequireProjectMembers = _.isArray(permissions)
    ? _.some(permissions, permission => Utils.isPermissionRequireProjectMembers(permission))
  ...
  const hasPermission = _.isArray(permissions)
    ? _.some(permissions, permission => Utils.hasPermissionByReq(permission, req))
...
export const ProjectView = (
  ...
  const hasAccess = Utils.hasAdminRole(authUser)
