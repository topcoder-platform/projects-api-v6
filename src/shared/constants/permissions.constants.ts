...
import { ProjectMemberRole as PROJECT_MEMBER_ROLE } from '../enums/projectMemberRole.enum';
import {
...
import { M2M_SCOPES } from '../enums/scopes.enum';
...
export const PERMISSION = {
  ...
  READ_PROJECT: {
    ...
    topcoderRoles: [
      ...
      USER_ROLE.TASK_MANAGER,
      USER_ROLE.TOPCODER_TASK_MANAGER,
  ...
  EDIT_PROJECT_ATTACHMENT: {
    meta: {
      ...
      group: 'Project Attachment',
      description: 'Who can edit attachment.',
    },
    topcoderRoles: TOPCODER_ROLES_MANAGERS_AND_ADMINS,
    projectRoles: [
      ...PROJECT_ROLES_MANAGEMENT,
  ...
  DELETE_PROJECT_ATTACHMENT: {
    meta: {
      ...
      group: 'Project Attachment',
      description: 'Who can delete attachment.',
    },
    topcoderRoles: TOPCODER_ROLES_MANAGERS_AND_ADMINS,
    projectRoles: [
      ...PROJECT_ROLES_MANAGEMENT,
