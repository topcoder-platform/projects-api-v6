...
class Utils {
  ...
  static isPermissionRequireProjectMembers (
    ...
    if (permission instanceof PermissionRule) {
      allowRule = permission as PermissionRule;
      denyRule = null;
    } else {
  ...
  static hasPermissionByReq (permission: PermissionRule, req: Request) {
    ...
    return Utils.hasPermission(permission, _.get(req, 'authUser'), _.get(req, 'context.currentProjectMembers'));
  }
   ...
   */
  static setResHeaders(req: Request, res: Response, result: SearchResult) {
